...
import com.ugopiemontese.openband.model.GattAttributes;
...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                Log.v(TAG, "Attempting to start service discovery:" + mBluetoothGatt.discoverServices());
    ...
    public BluetoothGattService getMiliService() {
        if (mBluetoothGatt == null)
            return null;
        return mBluetoothGatt.getService(SERVICE_MILI);
    }

    public BluetoothGattService getAlertService() {
        if (mBluetoothGatt == null)
            return null;
        return mBluetoothGatt.getService(SERVICE_ALERT);
    }
